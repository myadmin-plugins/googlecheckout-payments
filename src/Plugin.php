...
class Plugin
{
    ...
    public static function getSettings(GenericEvent $event)
    {
        ...
        $settings->add_password_setting(_('Billing'), _('Google Checkout'), 'google_checkout_merchant_key', _('Live Merchant Key'), _('Live Merchant Key'), (defined('GOOGLE_CHECKOUT_MERCHANT_KEY') ? GOOGLE_CHECKOUT_MERCHANT_KEY : ''));
        ...
        $settings->add_password_setting(_('Billing'), _('Google Checkout'), 'google_checkout_sandbox_merchant_key', _('Sandbox Merchant Key'), _('Sandbox Merchant Key'), (defined('GOOGLE_CHECKOUT_SANDBOX_MERCHANT_KEY') ? GOOGLE_CHECKOUT_SANDBOX_MERCHANT_KEY : ''));
    }
}
